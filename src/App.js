    ...
    <div className='main'>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path='/anniversary' element={<HomeCategory banner={Wedding_banner}   category="anniversary"/>} />
          <Route path='/mother' element={<HomeCategory banner={Wedding_banner}   category="mother"/>} />
          <Route path='/father' element={<HomeCategory banner={Wedding_banner}   category="father"/>} />
          <Route path='/val' element={<HomeCategory banner={Wedding_banner}   category="val"/>} />
